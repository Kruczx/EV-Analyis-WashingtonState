---
title: "EVAnalysisProject"
author: "Dheeraj Shetty and Marco Capoccia"
format: pdf
editor: visual
echo: True
---
...
city_plot <- ggplot(sub_evd, aes(x = City, fill = City)) +
  ...
  scale_fill_manual(values = c("red", "steelblue","lightgreen","orange"))
...
ggplot(make_evd, aes(x = Make, fill = Electric.Vehicle.Type)) +
  ...
  scale_fill_manual(values = c("Battery Electric Vehicle (BEV)" = "lightgreen",
